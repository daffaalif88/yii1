...
class Peserta extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama, tanggal_lahir, alamat, no_telp, email, tanggal_pendaftaran, status_keanggotaan, keterangan', 'required'),
			array('nama, no_telp, email, status_keanggotaan', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nama, tanggal_lahir, alamat, no_telp, email, tanggal_pendaftaran, status_keanggotaan, keterangan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('status_keanggotaan',$this->status_keanggotaan,true);
